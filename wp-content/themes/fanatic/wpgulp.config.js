...
const projectURL = 'http://localhost:8888/fanatic';
...
const styleSRC = './assets/src/css/main.scss';

// Path to place the compiled CSS file. Default set to root folder.
const styleDestination = './assets/dist/css/';
...
const jsCustomSRC = './assets/src/js/*.js';
...
const watchJsCustom = './assets/src/js/*.js';
...
const textDomain = 'fanatic';

// Name of the translation file.
const translationFile = 'fanatic.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'fanatic';

// Where can users report bugs.
const bugReport = 'rahat@iamrahat.uk';

// Last translator Email ID.
const lastTranslator = 'Rahat Hussain <rahat@iamrahat.uk>';

// Team's Email ID.
const team = 'Rahat <rahat@iamrahat.uk>';
