...
/*
===========================================================================================================================
 Add some indents to Custom Stylesheets to Fanatic Theme
===========================================================================================================================
*/

function fanatic_scripts() {
	wp_enqueue_style( 'fanatic', get_template_directory_uri() . '/assets/dist/css/main.css' );
	wp_enqueue_script( 'fanatic-app',  get_template_directory_uri() . '/assets/src/js/app.js', array( 'jquery' ), '20151215', true );
	wp_enqueue_script( 'fanatic-app-hsimp',  get_template_directory_uri() . '/assets/src/js/hsimp.min.js', array( 'jquery' ), '20151215', true );
}
